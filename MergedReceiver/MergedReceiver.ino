...
struct clientInput parseClientInput(String inputMessage) {
    ...
    holder.onOffInput = inputMessage.substring(0,1).toInt();
    holder.directionInput = inputMessage.substring(1,2).toInt();
    holder.motorSpeed = inputMessage.substring(2,5).toInt();
